  ...
  "metadata": {
    ...
    "widgets": {
      "application/vnd.jupyter.widget-state+json": {
        "71450b765bfe4e7c9dbffbac9e61e877": {
          ...
          "state": {
            ...
            "layout": "IPY_MODEL_160da5839c574da289b4c923d390a752",
            "msg_id": "",
            "outputs": [
              {
                "output_type": "display_data",
                "data": {
                  "text/plain": "Epoch 0/0  \u001b[38;2;98;6;224m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m 28/28 \u001b[2m0:00:01 • 0:00:00\u001b[0m \u001b[2;4m35.97it/s\u001b[0m \u001b[3mv_num: 1.000 train_loss: 0.627     \u001b[0m\n                                                                                \u001b[3mtrain_acc: 0.833 val_loss: 0.696   \u001b[0m\n                                                                                \u001b[3mval_acc: 0.478                     \u001b[0m\n",
                  "text/html": "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\">Epoch 0/0  <span style=\"color: #6206e0; text-decoration-color: #6206e0\">━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━</span> 28/28 <span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\">0:00:01 • 0:00:00</span> <span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f; text-decoration: underline\">35.97it/s</span> <span style=\"font-style: italic\">v_num: 1.000 train_loss: 0.627     </span>\n                                                                                <span style=\"font-style: italic\">train_acc: 0.833 val_loss: 0.696   </span>\n                                                                                <span style=\"font-style: italic\">val_acc: 0.478                     </span>\n</pre>\n"
                },
                "metadata": {}
              }
            ]
        ...
        "160da5839c574da289b4c923d390a752": {
  ...
  "cells": [
    {
      ...
      "metadata": {
        ...
        "outputId": "e82fd6af-8658-427d-ff23-21b75d420fa6"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        "%%capture\n",
        "!unzip \"/content/drive/MyDrive/EEG dataset of individuals with intellectual and developmental disorder and healthy controls while observing rest and musical stimulus.zip\" -d ."
      ],
      "metadata": {
        "id": "pmWxTC-vuGOg"
      },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "26f2edc3-e712-4e76-9593-8c4538c497d0"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "465bb963-0778-45bf-83f2-3e22437f1d41"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "cea342f2-1ae5-4fde-8f96-972452bc8a2d"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "914f2c93-50b0-407d-e383-77a0588e8399"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "fbed726c-a97f-43c9-8c4c-0708d9eea2fd"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "5173bb9b-37c9-4077-dba3-d00597437eda"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "2d6216f3-112b-4ec9-a5e8-c6db6ee55701"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "d24bab90-0ef1-4f99-9df1-b4a59565b50c"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "c1600fba-668c-43ce-8f7f-6f8b92ffad01"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "379ead66-7546-4fb3-edb0-13e35ecbc04e"
      },
      "execution_count": null,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Requirement already satisfied: torch>=2.1.0 in /usr/local/lib/python3.12/dist-packages (from pytorch-lightning) (2.10.0+cu128)\n",
            ...
            "Requirement already satisfied: packaging>=23.0 in /usr/local/lib/python3.12/dist-packages (from pytorch-lightning) (26.1)\n",
            ...
            "Requirement already satisfied: aiohttp!=4.0.0a0,!=4.0.0a1 in /usr/local/lib/python3.12/dist-packages (from fsspec[http]>=2022.5.0->pytorch-lightning) (3.13.5)\n",
            "Requirement already satisfied: filelock in /usr/local/lib/python3.12/dist-packages (from torch>=2.1.0->pytorch-lightning) (3.29.0)\n",
            "Requirement already satisfied: setuptools in /usr/local/lib/python3.12/dist-packages (from torch>=2.1.0->pytorch-lightning) (75.2.0)\n",
            ...
            "Requirement already satisfied: cuda-bindings==12.9.4 in /usr/local/lib/python3.12/dist-packages (from torch>=2.1.0->pytorch-lightning) (12.9.4)\n",
            ...
            "Requirement already satisfied: nvidia-nvshmem-cu12==3.4.5 in /usr/local/lib/python3.12/dist-packages (from torch>=2.1.0->pytorch-lightning) (3.4.5)\n",
            ...
            "Requirement already satisfied: triton==3.6.0 in /usr/local/lib/python3.12/dist-packages (from torch>=2.1.0->pytorch-lightning) (3.6.0)\n",
            "Requirement already satisfied: cuda-pathfinder~=1.1 in /usr/local/lib/python3.12/dist-packages (from cuda-bindings==12.9.4->torch>=2.1.0->pytorch-lightning) (1.5.3)\n",
            ...
            "Requirement already satisfied: attrs>=17.3.0 in /usr/local/lib/python3.12/dist-packages (from aiohttp!=4.0.0a0,!=4.0.0a1->fsspec[http]>=2022.5.0->pytorch-lightning) (26.1.0)\n",
            ...
            "Requirement already satisfied: yarl<2.0,>=1.17.0 in /usr/local/lib/python3.12/dist-packages (from aiohttp!=4.0.0a0,!=4.0.0a1->fsspec[http]>=2022.5.0->pytorch-lightning) (1.23.0)\n",
            ...
            "Requirement already satisfied: idna>=2.0 in /usr/local/lib/python3.12/dist-packages (from yarl<2.0,>=1.17.0->aiohttp!=4.0.0a0,!=4.0.0a1->fsspec[http]>=2022.5.0->pytorch-lightning) (3.13)\n",
            "Downloading pytorch_lightning-2.6.1-py3-none-any.whl (857 kB)\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m857.3/857.3 kB\u001b[0m \u001b[31m22.6 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[?25hDownloading torchmetrics-1.9.0-py3-none-any.whl (983 kB)\n",
            "\u001b[2K   \u001b[90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\u001b[0m \u001b[32m983.4/983.4 kB\u001b[0m \u001b[31m64.7 MB/s\u001b[0m eta \u001b[36m0:00:00\u001b[0m\n",
            "\u001b[?25hDownloading lightning_utilities-0.15.3-py3-none-any.whl (31 kB)\n",
            "Installing collected packages: lightning-utilities, torchmetrics, pytorch-lightning\n",
            "Successfully installed lightning-utilities-0.15.3 pytorch-lightning-2.6.1 torchmetrics-1.9.0\n"
          ]
        }
      ]
    },
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "9e7df041-2fc4-4777-ba87-71e89b6625ac"
      },
      "execution_count": null,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "3eef983d-68bc-4583-b4d2-80abb4e7b7de"
      },
      "execution_count": null,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            "text/plain": [
              ...
              "┡━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━╇━━━━━━━┩\n",
              "│\u001b[2m \u001b[0m\u001b[2m0\u001b[0m\u001b[2m \u001b[0m│ model     │ ChronoNet         │  133 K │ train │     0 │\n",
              "│\u001b[2m \u001b[0m\u001b[2m1\u001b[0m\u001b[2m \u001b[0m│ acc       │ BinaryAccuracy    │      0 │ train │     0 │\n",
              "│\u001b[2m \u001b[0m\u001b[2m2\u001b[0m\u001b[2m \u001b[0m│ creterion │ BCEWithLogitsLoss │      0 │ train │     0 │\n",
              "└───┴───────────┴───────────────────┴────────┴───────┴───────┘\n"
            ],
            "text/html": [
              ...
              "┡━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━╇━━━━━━━┩\n",
              "│<span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\"> 0 </span>│ model     │ ChronoNet         │  133 K │ train │     0 │\n",
              "│<span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\"> 1 </span>│ acc       │ BinaryAccuracy    │      0 │ train │     0 │\n",
              "│<span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\"> 2 </span>│ creterion │ BCEWithLogitsLoss │      0 │ train │     0 │\n",
              "└───┴───────────┴───────────────────┴────────┴───────┴───────┘\n",
              "</pre>\n"
            ]
          },
        ...
        },
        {
          ...
          "data": {
            ...
            "application/vnd.jupyter.widget-view+json": {
              "version_major": 2,
              "version_minor": 0,
              "model_id": "71450b765bfe4e7c9dbffbac9e61e877"
            }
          },
          "metadata": {}
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\">/usr/local/lib/python3.12/dist-packages/pytorch_lightning/utilities/_pytree.py:21: `isinstance(treespec, LeafSpec)`\n",
              "is deprecated, use `isinstance(treespec, TreeSpec) and treespec.is_leaf()` instead.\n",
              "</pre>\n"
            ]
          },
